namespace Lexs4SearchRetrieveWebService
{
    ...
    public partial class FirearmType : TangibleItemType
    {
        ...
        private LengthMeasureType firearmBarrelLengthMeasureField;
        ...
        public LengthMeasureType FirearmBarrelLengthMeasure
        {
            get
            {
                return this.firearmBarrelLengthMeasureField;
            }
            set
            {
                this.firearmBarrelLengthMeasureField = value;
            }
        }
        
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("FirearmCaliberCode", typeof(CALCodeType), IsNullable=true, Order=5)]
        [System.Xml.Serialization.XmlElementAttribute("FirearmCaliberText", typeof(TextType), IsNullable=true, Order=5)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("FirearmFinishCode", typeof(GUNColorFinishCodeType), IsNullable=true, Order=6)]
        [System.Xml.Serialization.XmlElementAttribute("FirearmFinishText", typeof(TextType), IsNullable=true, Order=6)]
        public object Item3
        {
            get
            {
