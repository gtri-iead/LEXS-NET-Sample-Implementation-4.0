namespace Lexs4SearchRetrieveWebService
{
    ...
    public partial class EntityTangibleItemType : EntityType
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ForceVictim", Namespace="http://niem.gov/niem/domains/jxdm/4.1", IsNullable=true, Order=3)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("IncidentVictim", Namespace="http://niem.gov/niem/domains/jxdm/4.1", IsNullable=true, Order=4)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Victim", Namespace="http://niem.gov/niem/domains/jxdm/4.1", IsNullable=true, Order=5)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Pawn", IsNullable=true, Order=6)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Property", Namespace="http://niem.gov/niem/niem-core/2.0", IsNullable=true, Order=7)]
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("Weapon", Namespace="http://niem.gov/niem/niem-core/2.0", IsNullable=true, Order=8)]
